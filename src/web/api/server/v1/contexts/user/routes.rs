...
use super::handlers::{
    ban_handler, email_verification_handler, get_user_profiles_handler, login_handler, oidc_callback_handler, oidc_login_handler,
    registration_handler, renew_token_handler, revoke_api_key_handler, tracker_announce_handler, user_api_keys_create_handler,
    user_api_keys_list_handler, verify_token_handler,
};
use crate::common::AppData;
use crate::web::api::server::v1::routes::require_auth_middleware;
...
pub fn router(app_data: Arc<AppData>) -> Router {
    ...
    let public_routes = Router::new()
        ...
        // Token helpers (they validate/renew a token provided in the payload)
...
pub fn router_for_multiple_resources(app_data: Arc<AppData>) -> Router {
    Router::new()
        .route("/", get(get_user_profiles_handler).with_state(app_data.clone()))
        .route_layer(middleware::from_fn_with_state(app_data, require_auth_middleware))
}
